...
module.exports = function(url, options) {
  ...
  for(var i = 0; i < strings.length; i++) {
    ...
    if(hostString.indexOf('mongodb') != -1) {
      if(hostString.indexOf('@') != -1) {
        ...
        hosts.push(hostString.substr('mongodb+srv://'.length));
      }
  ...
  for(var i = 0; i < hosts.length; i++) {
    var r = parser.parse(f('mongodb+srv://%s', hosts[i].trim()));
  ...
  if(url.indexOf("?") != -1) {
    ...
    connection_part = url.substring("mongodb+srv://".length, url.indexOf("?"))
  } else {
    connection_part = url.substring("mongodb+srv://".length);
  }
  ...
  if(url.match(/\.sock/)) {
    ...
    var domainSocket = url.substring(
        url.indexOf("mongodb+srv://") + "mongodb+srv://".length
