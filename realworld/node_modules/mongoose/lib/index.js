 ...
 * ####Example:
 *
 *     // with mongodb+srv:// URI
 *     db = mongoose.createConnection('mongodb+srv://user:pass@localhost:port/database');
 *
 *     // and options
 *     var opts = { db: { native_parser: true }}
 *     db = mongoose.createConnection('mongodb+srv://user:pass@localhost:port/database', opts);
 *
 *     // replica sets
 *     db = mongoose.createConnection('mongodb+srv://user:pass@localhost:port,anotherhost:port,yetanother:port/database');
 *
 *     // and options
 *     var opts = { replset: { strategy: 'ping', rs_name: 'testSet' }}
 *     db = mongoose.createConnection('mongodb+srv://user:pass@localhost:port,anotherhost:port,yetanother:port/database', opts);
 *
 ...
 *
 * @param {String} [uri] a mongodb+srv:// URI
 ...
 * ####Example:
 *
 *     mongoose.connect('mongodb+srv://user:pass@localhost:port/database');
 *
 *     // replica sets
 *     var uri = 'mongodb+srv://user:pass@localhost:port,anotherhost:port,yetanother:port/mydatabase';
 ...
 *     var uri = 'mongodb+srv://hostA:27501,hostB:27501';
 *     var opts = { mongos: true };
 *     mongoose.connect(uri, opts);
 *
 *     // optional callback that gets fired when initial connection completed
 *     var uri = 'mongodb+srv://nonexistent.domain:27000';
