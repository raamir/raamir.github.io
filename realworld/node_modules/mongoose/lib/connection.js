 ...
 *
 * @param {String} connection_string mongodb+srv://uri or the host to which you are connecting
 ...
 *     db.openSet("mongodb+srv://user:pwd@localhost:27020/testing,mongodb+srv://example.com:27020,mongodb+srv://localhost:27019");
 *
 ...
 *
 *     conn.open('mongodb+srv://mongosA:27501,mongosB:27501', { mongos: true }, cb);
 *
 * Mongoose forces the db option `forceServerObjectId` false and cannot be overridden.
 * Mongoose defaults the server `auto_reconnect` options to true which can be overridden.
 * See the node-mongodb-native driver instance for options that it understands.
 ...
 * _Options passed take precedence over options included in connection strings._
 *
 * @param {String} uris comma-separated mongodb+srv:// `URI`s
