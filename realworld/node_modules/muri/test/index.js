...
describe('muri', function(){
  it('must begin with mongodb+srv://', function(done){
    assert.throws(function () {
      muri('localhost:27017');
    }, /Invalid mongodb uri/);
    assert.doesNotThrow(function () {
      muri('mongodb+srv://localhost:27017');
    })
    done();
  })
  ...
  describe('user:password', function(done){
    it('is optional', function(done){
      var uri = 'mongodb+srv://local:27017';
      var val = muri(uri);
      assert.ok(!val.auth);
      done();
    })
    ...
    it('parses properly', function(done){
      var uri = 'mongodb+srv://user:password@local:27017';
      var val = muri(uri);
      assert.ok(val.auth);
    ...
    it('handles # in the username', function(done){
      var uri = 'mongodb+srv://us#er:password@local:27017';
      var val = muri(uri);
      assert.ok(val.auth);
    ...
    it('handles # in the password', function(done){
      var uri = 'mongodb+srv://user:pa#ssword@local:27017';
      var val = muri(uri);
      assert.ok(val.auth);
      assert.equal('user', val.auth.user);
  ...
  describe('host', function(){
    it('must be specified', function(done){
      ...
      assert.throws(function () {
        muri('mongodb+srv:///fake');
      }, /Missing host/)
      assert.throws(function () {
        muri('mongodb+srv://?yep');
      }, /Missing host/)
      assert.throws(function () {
        muri('mongodb+srv:///?yep');
      }, /Missing host/)

      var val = muri('mongodb+srv://local');
    ...
    it('supports replica sets', function(done){
      var val = muri('mongodb+srv://local:27017,remote:27018,japan:99999');
      assert.ok(Array.isArray(val.hosts));
  ...
  describe('port', function(){
    ...
    describe('with single host', function(){
      ...
      it('uses what is specified', function(done){
        var val = muri('mongodb+srv://local:27018');
    ...
    describe('with replica sets', function(){
      ...
      before(function(){
        val = muri('mongodb+srv://local,remote:27018,another');
      })
  ...
  describe('database', function(){
    it('default', function(done){
      var val = muri('mongodb+srv://localhost/');
    ...
    it('is overridable', function(done){
      var val = muri('mongodb+srv://localhost,a,x:34343,b/muri');
      assert.equal('muri', val.db);
      done();
    })
    it('works with multiple specified protocols', function(done){
      var uri = 'mongodb+srv://localhost:27020/testing,mongodb+srv://localhost:27019,mongodb+srv://localhost:27018'
      var val = muri(uri);
  ...
  describe('querystring separator', function(){
    it('can be ; ', function(done){
      var val = muri('mongodb+srv://muri/?replicaSet=myreplset;slaveOk=true;x=1');
  ...
  describe('readPref tags', function(){
    describe('with & ', function(){
      it('mongodb+srv://localhost/?readPreferenceTags=dc:ny', function(done){
        var val = muri('mongodb+srv://localhost/?readPreferenceTags=dc:ny');
        assert.equal('test', val.db);
        assert.deepEqual([{ dc: 'ny' }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb+srv://localhost/?readPreferenceTags=dc:ny,rack:1', function(done){
        var val = muri('mongodb+srv://localhost/?readPreferenceTags=dc:ny,rack:1');
        assert.deepEqual([{ dc: 'ny', rack: 1 }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb+srv://localhost/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2', function(done){
        var val = muri('mongodb+srv://localhost/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2');
        assert.deepEqual([{ dc: 'ny', rack: 1 }, { dc: 'sf', rack: 2 }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb+srv://localhost/db?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2&readPreferenceTags=', function(done){
        var val = muri('mongodb+srv://localhost/db?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2&readPreferenceTags=');
        assert.deepEqual([{ dc: 'ny', rack: 1 }, { dc: 'sf', rack: 2 }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb+srv://localhost/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:ny&readPreferenceTags=', function(done){
        var val = muri('mongodb+srv://localhost/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:ny&readPreferenceTags=');
  ...
  describe('unix domain sockets', function(){
    it('without auth', function(done){
      var val = muri('mongodb+srv:///tmp/mongodb-27017.sock?safe=false');
    ...
    it('without auth with a database name', function(done){
      var val = muri('mongodb+srv:///tmp/mongodb-27017.sock/tester?safe=false');
    ...
    it('with auth', function(done){
      var val = muri('mongodb+srv://user:password@/tmp/mongodb-27017.sock?safe=false');
    ...
    it('with auth with a db name', function(done){
      var val = muri('mongodb+srv://user:password@/tmp/mongodb-27017.sock/tester?safe=false');
      assert.equal(val.db, 'tester')
      assert.ok(Array.isArray(val.hosts));
      assert.equal(1, val.hosts.length);
      assert.equal(val.hosts[0].ipc, '/tmp/mongodb-27017.sock')
    ...
    it('with auth + repl sets', function(done){
      var val = muri('mongodb+srv://user:password@/tmp/mongodb-27017.sock,/tmp/another-27018.sock?safe=false');
      assert.equal(val.db, 'admin')
      assert.ok(Array.isArray(val.hosts));
    ...
    it('with auth + repl sets with a db name', function(done){
      var val = muri('mongodb+srv://user:password@/tmp/mongodb-27017.sock,/tmp/another-27018.sock/tester?safe=false');
      assert.equal(val.db, 'tester')
      assert.ok(Array.isArray(val.hosts));
      assert.equal(2, val.hosts.length);
      assert.equal(val.hosts[0].ipc, '/tmp/mongodb-27017.sock')
  ...
  it('all together now', function(done){
    var uri = 'mongodb+srv://u#ser:pas#s@local,remote:27018,japan:27019/neatdb'
  ...
  it('ipv6', function(done) {
    var uri = 'mongodb+srv://[::1]:27017/test';
    var val = muri(uri);
    assert.equal(1, val.hosts.length);
